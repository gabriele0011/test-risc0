...
├── contracts
│   ├── InsertionSort.sol              // Basic example contract for you to modify
...
└── tests
    ├── InsertionSort.t.sol            // Tests for the basic example contract
