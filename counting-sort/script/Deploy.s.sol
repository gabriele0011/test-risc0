...
contract InsertionSortDeploy is Script, RiscZeroCheats {
    ...
    function run() external {
        ...
        CountingSort countingSort = new CountingSort(verifier);
        console2.log("Deployed InsertionSort to", address(countingSort));
