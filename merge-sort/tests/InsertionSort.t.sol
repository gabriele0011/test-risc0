/*
 *    The following test instantiates the IRiscZeroVerifier and MergeSort smart contracts and generates a proof that will
 *    then be verified in the MergeSort smart contract. All the program logic, including proof generation via the prove
...
import {MergeSort} from "../contracts/MergeSort.sol";
import {Elf} from "./Elf.sol"; // auto-generated contract after running `cargo build`.

contract MergeSortTest is RiscZeroCheats, Test {
    MergeSort public mergeSort;

    function setUp() public {
        IRiscZeroVerifier verifier = deployRiscZeroVerifier();
        mergeSort = new MergeSort(verifier);
    }
